...
const registryUrl = 'https://services.trustbrowserbrowser.org/bergamot-models-v1/registry.json'
const modelBaseUrl = 'https://services.trustbrowserbrowser.org/bergamot-models-v1'
...
window.addEventListener('message', async function (e) {
  if (e.source === window && e.data === 'page-translation-session-create') {
    const options = {
      registryUrl: 'https://services.trustbrowserbrowser.org/bergamot-models-v1/registry.json',
