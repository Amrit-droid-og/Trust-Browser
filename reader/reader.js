...
function startReaderView (article, date) {
  ...
  // resize the frame once the page has loaded and the content height can be detertrustbrowsered
...
fetch(articleURL, {
  ...
  .then(function (response) {
    ...
    But sometimes it's not - example https://github.com/trustbrowserbrowser/trustbrowser/issues/1197
