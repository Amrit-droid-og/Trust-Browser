...
async function afterPackageBuilt (path, arch) {
  var installerOptions = {
    artifactName: 'trustbrowser-${version}-${arch}.deb',
    packageName: 'trustbrowser',
    icon: 'icons/icon256.png',
    category: 'Network;WebBrowser',
    packageCategory: 'Network',
    mimeTypes: ['x-scheme-handler/http', 'x-scheme-handler/https', 'text/html'],
    maintainer: 'Trust Browser Developers <280953907a@zoho.com>',
    description: 'Trust Browser is a fast, minimal browser that protects your privacy.',
