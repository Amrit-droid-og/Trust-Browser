...
function initialize () {
  ...
  var captionTrust Browserimize =
  document.querySelector('.windows-caption-buttons .caption-trustbrowserimise, body.linux .titlebar-linux .caption-trustbrowserimise')
  ...
  var linuxTrust Browserimize = document.querySelector('#linux-control-buttons #minimize-button')
  ...
  if (window.platformType === 'windows') {
    ...
    captionTrust Browserimize.addEventListener('click', function (e) {
      ipc.invoke('minimize')
    })
  ...
  if (window.platformType === 'linux') {
    ...
    linuxTrust Browserimize.addEventListener('click', function (e) {
      ipc.invoke('minimize')
    })
  }
}
