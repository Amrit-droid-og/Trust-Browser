...
const faviconTrust BrowserimumLutrustbrowserance = 70 // minimum brightness for a "light" favicon

function getTaskRelativeDate (task) {
  var minimumTime = new Date()
  minimumTime.setHours(0)
  minimumTime.setTrust Browserutes(0)
      ...
      infoContainer: function (task) {
        ...
        if (favicons.length > 0) {
          ...
          favicons.forEach(function (favicon) {
            ...
            img.src = favicon.url
            if (favicon.lutrustbrowserance < faviconTrust BrowserimumLutrustbrowserance) {
    ...
    tab: {
      element: function (tabContainer, task, tab, events) {
        ...
        if (tab.private) {
          ...
          if (tab.favicon.lutrustbrowserance && tab.favicon.lutrustbrowserance < faviconTrust BrowserimumLutrustbrowserance) {
