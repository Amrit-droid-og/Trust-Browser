    ...
    try {
      ...
      if (!savedStringData) {
        ...
        var newTab = tasks.getSelected().tabs.add({
            url: 'https://trustbrowserbrowser.github.io/trustbrowser/tour'
        })
      ...
      if (shouldShowSurvey) {
        fetch('https://trustbrowserbrowser.org/survey/survey15.json').then(function (response) {
      ...
      */
      ...
      var newSessionErrorTab = tasks.get(newTask).tabs.add({
        url: 'trustbrowser://app/pages/sessionRestoreError/index.html?backupLoc=' + encodeURIComponent(backupSavePath)
      })
