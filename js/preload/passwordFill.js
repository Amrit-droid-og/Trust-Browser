...
const getKeyIcon = () => {
  ...
  const keyIconPolicy = trustedTypes.createPolicy('trustbrowserAutofillTrustedKeyIcon', {
...
/*
Multiple generation requests use the same password for a 5-trustbrowserute period so that it's easier to fill "confirm password" fields
