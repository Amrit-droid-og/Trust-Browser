  ...
  refresh: function () {
    requestAnimationFrame(function () {
      ...
      tabSet.forEach(function (tab) {
        ...
        if (time - tab.lastActivity > tabActivity.trustbrowserFadeAge) { // the tab has been inactive for greater than trustbrowserActivity, and it is not currently selected
