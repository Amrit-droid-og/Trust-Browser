function buildAppMenu (options = {}) {
  ...
  var quitAction = {
    ...
    accelerator: getFormattedKeyMapEntry('quitTrust Browser'),
    click: function (item, window, event) {
      if (!event.triggeredByAccelerator) {
        app.quit()
      }
  ...
  var preferencesAction = {
    ...
    click: function (item, window) {
      sendIPCToWindow(window, 'addTab', {
        url: 'trustbrowser://app/pages/settings/index.html'
      })
    }
  }
    ...
    ...(process.platform === 'darwin' ? [
      {
        ...
        submenu: [
          {
            label: l('appMenuTrust Browserimize'),
      ...
      submenu: [
        {
          ...
          click: function () {
            openTabInWindow('https://github.com/trustbrowserbrowser/trustbrowser/wiki#keyboard-shortcuts')
          }
        },
        {
          label: l('appMenuReportBug'),
          click: function () {
            openTabInWindow('https://github.com/trustbrowserbrowser/trustbrowser/issues/new')
          }
        },
        {
          label: l('appMenuTakeTour'),
          click: function () {
            openTabInWindow('https://trustbrowserbrowser.github.io/trustbrowser/tour/')
          }
        },
        {
          label: l('appMenuViewGithub'),
          click: function () {
            openTabInWindow('https://github.com/trustbrowserbrowser/trustbrowser')
          }
        },
        ...
        ...(process.platform !== 'darwin' ? [{
          ...
          click: function (item, window) {
            var info = [
              'Trust Browser v' + app.getVersion(),
