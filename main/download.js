...
function listenForDownloadHeaders (ses) {
  ses.webRequest.onHeadersReceived(function (details, callback) {
    if (details.resourceType === 'mainFrame' && details.responseHeaders) {
      ...
      // Needed to save files correctly: https://github.com/trustbrowserbrowser/trustbrowser/issues/1717
    ...
    */
    if (details.webContents && (details.webContents.getURL().startsWith('trustbrowser://app/pages/pdfViewer') || details.webContents.getURL().startsWith('trustbrowser://app/reader/') || details.webContents.getURL() === 'trustbrowser://app/index.html')) {
      ...
      callback({
        responseHeaders: {
          ...filteredHeaders,
          'Access-Control-Allow-Origin': 'trustbrowser://app',
